...
.message_template {
  display: none;
				...
				<h4 class="elementor-icon-box-title">
					<span>
						We are live and ready to chat with you now. 			</span>
				</h4>
<?php
if(!isset($_COOKIE['chatapp_cookies'])){
	?>
									...
									<p class="elementor-icon-box-description">
										<label> Fullname <span style="color: red;" >*</span><br>
											...
											<label> Email <span style="color: red;" >*</span><br>
												...
												<label> Phone <br>
													<input  type="text" name="phone" value="" size="20" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"> </label><br />
													<label> Matric Number <br>
													<input  type="text" name="matno" value="" size="20" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"> </label><br />
													<label> Department to contact<span style="color: red;" >*</span><br>
													
													<select required  name="dept" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required">
													<?php
				$sql = "SELECT id, `name` FROM departments where `status` = 1";
				...
				?>		
														...
														<br />
														<label> Language <span style="color: red;" >*</span><br>
															<select required name="lang"  class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required">
															<?php
				$sql = "SELECT id, `name` FROM languages where `status` = 1";
				$result = mysqli_query($conn, $sql);
				...
				?>		
															...
															<input type="submit" value="Start Chat" class="wpcf7-form-control has-spinner wpcf7-submit"><span class="wpcf7-spinner"></span>
										</p>
...
<?php include_once 'faq_content.php' ;?>
	...
	if((isset($_POST['fullname'])) and ($_POST['fullname'] != "")){
		...
		$first_msg = "";
		$first_msg = "My name is $fullname <br /> \r\n";
		$first_msg .= "Email: $email <br /> \r\n";
		$first_msg .=  "I understand $lang language <br /> \r\n";
		$first_msg .=  "I want to chat with $dept department agent";
		if(isset($email)){
		$sql = "INSERT INTO `users` (`id`, `language_id`, `department_id`, `fullname`, `matric`, `phone`, `email`, `status`, `avatar`, `ip_address`, `first_message`) VALUES
		 (NULL, '$lang', '$dept', '$fullname', '$matno', '$phone', '$email', '1', NULL, '$ip', '$first_msg');";
...
$newmsg =  "My Name is $fullname";
$session_id = $_COOKIE['chatapp_cookies'];
$ip = $_SERVER['REMOTE_ADDR'];
if(isset($last_id)){
$sql = "INSERT INTO `messages` (`id`, `user_id`, `ip_address`, `messages`, `admin_id`, `status`, `deleted`, `seen`, `userfile`, `department_id`, `session_id`) VALUES 
(NULL, '$last_id', '$ip', '$newmsg ', '1', '1', '0', '0', NULL, '1', '$last_id'  );";
mysqli_query($conn, $sql) ;
$newmsg =  "Email is  $email";
$sql = "INSERT INTO `messages` (`id`, `user_id`, `ip_address`, `messages`, `admin_id`, `status`, `deleted`, `seen`, `userfile`, `department_id`, `session_id`) VALUES 
(NULL, '$last_id', '$ip', '$newmsg ', '1', '1', '0', '0', NULL, '1', '$last_id');";
mysqli_query($conn, $sql) ;

$newmsg =  "I want to chat with  $dept departement";
$sql = "INSERT INTO `messages` (`id`, `user_id`, `ip_address`, `messages`, `admin_id`, `status`, `deleted`, `seen`, `userfile`, `department_id`, `session_id`) VALUES 
(NULL, '$last_id', '$ip', '$newmsg ', '1', '1', '0', '0', NULL, '1', '$last_id');";
mysqli_query($conn, $sql) ;
}
