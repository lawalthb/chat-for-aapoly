                                        ...
                                        <div class="d-flex q-col-gutter-xs justify-btween">
                                            <div class="dropdown" >
                                                ...
                                                <ul class="dropdown-menu">
                                                    <a class="dropdown-item "   href="<?php print_link("languages/edit/$rec_id"); ?>">
                                                    <i class="material-icons">edit</i> {{ __('edit') }}
                                                </a>
                                                <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("languages/delete/$rec_id"); ?>">
