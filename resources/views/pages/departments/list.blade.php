        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="col-md-auto " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("departments/add") ?>" >
                    <i class="material-icons">add</i>                               
                    {{ __('addNewDepartments') }} 
                </a>
            </div>
            <div class="col-md-3 " >
                                                ...
                                                <td class="td-btn">
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <a class="dropdown-item "   href="<?php print_link("departments/view/$rec_id"); ?>">
                        ...
                        <div class="row justify-content-center">    
                            <div class="col-md-auto justify-content-center">    
                                <div class="p-3 d-flex justify-content-between">    
                                    <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("departments/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
