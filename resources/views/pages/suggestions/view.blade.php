...
<?php
    $pageTitle = __('suggestionsDetails');
?>
@extends($layout)
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <div class="border-top td-subject p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                        ...
                                        <div class="border-top td-body p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> {{ __('body') }}</div>
                                                    <div class="font-weight-bold">
                                                        <?php echo  $data['body'] ; ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="border-top td-fullname p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> {{ __('fullname') }}</div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <div class="d-flex q-col-gutter-xs justify-btween">
                                            <div class="dropdown" >
                                                ...
                                                <ul class="dropdown-menu">
                                                    <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("suggestions/delete/$rec_id"); ?>">
