...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-sm-6">
            ...
            <img src="{{ asset('images/aapoly-1 (1)2.png') }}" width="400px" height="400px" class="img-fluid " /><br />
           <h4> &nbsp; &nbsp; &nbsp; &nbsp;Web-Base Chat Application </h4>
                <div>
                    @if($errors->any())
                    ...
                    <form name="loginForm" action="{{ route('auth.login') }}" class="needs-validation form page-form" method="post">
                        ...
                        <div class="input-group form-group">
                            <input placeholder="{{ __('email') }}" name="username"  required="required" class="form-control" type="text"  />
                ...
                <h4> <center> A final year project by <br />
                     <u>Adeshina Omotalani</u> <br />   HNSD/12/0211 <br />Supervised by <br /> <u>Mr. Lecturer Name</u></center></h4>
